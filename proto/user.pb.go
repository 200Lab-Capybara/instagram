...
func (x *GetUserByIdsReq) GetIds() []string {
	if x != nil {
		return x.Ids
	}
	return nil
...
type PublicUsersInfosResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PublicUsersInfosResp) Reset() {
	*x = PublicUsersInfosResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *PublicUsersInfosResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublicUsersInfosResp) ProtoMessage() {}

func (x *PublicUsersInfosResp) ProtoReflect() protoreflect.Message {
	mi := &file_proto_user_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublicUsersInfosResp.ProtoReflect.Descriptor instead.
func (*PublicUsersInfosResp) Descriptor() ([]byte, []int) {
	return file_proto_user_proto_rawDescGZIP(), []int{4}
}

func (x *PublicUsersInfosResp) GetUsers() []*PublicUserInfo {
	if x != nil {
		return x.Users
	}
	return nil
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x23, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x42, 0x79, 0x49, 0x64, 0x73, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x69,
	0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xdc, 0x01,
	...
	0x09, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x3c, 0x0a, 0x12,
	...
	,
}
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*GetUserByIdsReq)(nil),      // 1: pb.GetUserByIdsReq
	(*PublicUserInfo)(nil),       // 2: pb.PublicUserInfo
	(*PublicUserInfoResp)(nil),   // 3: pb.PublicUserInfoResp
	(*PublicUsersInfosResp)(nil), // 4: pb.PublicUsersInfosResp
}
var file_proto_user_proto_depIdxs = []int32{
	2, // 0: pb.PublicUserInfoResp.user:type_name -> pb.PublicUserInfo
	2, // 1: pb.PublicUsersInfosResp.users:type_name -> pb.PublicUserInfo
	0, // 2: pb.UserService.GetUserById:input_type -> pb.GetUserByIdReq
	1, // 3: pb.UserService.GetUserByIds:input_type -> pb.GetUserByIdsReq
	3, // 4: pb.UserService.GetUserById:output_type -> pb.PublicUserInfoResp
	4, // 5: pb.UserService.GetUserByIds:output_type -> pb.PublicUsersInfosResp
...
func file_proto_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_user_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicUsersInfosResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
